...

{
    class ViewHolder(itemView:View):RecyclerView.ViewHolder(itemView)
    {
        ...
        val idText=itemView.findViewById<TextView>(R.id.idTxt)
        val titleText=itemView.findViewById<TextView>(R.id.titleTxt)
        val bodyText=itemView.findViewById<TextView>(R.id.bodyTxt)
    }
